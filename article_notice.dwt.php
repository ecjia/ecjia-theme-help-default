                    ...
                    <ul>
                        ...
                        <li class="clearfix">
                            <div class="new-list-detail" id="newsPart">
                                <a articleid="322" style="cursor: pointer;" class="current" target="_blank" href='{url path="article/notice/init"}&date={$date}&aid={$article_cat.id}&show=detail'>{$article_cat.title}</a>
                            </div>
