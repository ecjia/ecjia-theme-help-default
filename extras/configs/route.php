 ...
 */
return [
    'main/index/init'                               => 'pc_controller@init',

    'main/category/goods_list'                      => 'category_controller@goods_list',
    'main/category/food'                            => 'category_controller@food',

    'main/merchants_store/init'                     => 'merchants_store_controller@init',
    'main/merchants_store/home'                     => 'merchants_store_controller@home',
    'main/merchants_store/cat_store_list'           => 'merchants_store_controller@cat_store_list',

    'main/store_street/init'            => 'store_street_controller@init',
    'main/store_street/search_city'     => 'store_street_controller@search_city',
    'main/store_street/search_district' => 'store_street_controller@search_district',
    'main/store_street/store_shop'     => 'store_street_controller@store_shop',
    'main/store_street/search_cat'     => 'store_street_controller@search_cat',

    'main/brand/init'                  => 'brand_controller@init',
    'main/brand/goods'                  => 'brand_controller@goods',

    'main/ajax/get_content'             => 'ajaxdata_controller@get_content',
    'main/ajax/insert_header_region'             => 'ajaxdata_controller@insert_header_region',
...
//    'merchant/index/cat_store_list'               => 'merchant_controller@cat_store_list',
...
//    'cart/index/check_spec'             => 'cart_controller@check_spec', //检查购物车中商品规格
   'cart/index/drop_goods'             => 'cart_controller@drop_goods',
   'cart/index/ajax_update_cart'       => 'cart_controller@ajax_update_cart',
...
//    'cart/flow/goods_list'              => 'cart_controller@goods_list',
    ...
    'cart/flow/ajax_cart_goods_amount'  => 'cart_controller@ajax_cart_goods_amount',//新增
    'cart/flow/goods_stock_exhausted'   => 'cart_controller@goods_stock_exhausted',
    'cart/flow/shipping_prompt'         => 'cart_controller@shipping_prompt',
    'cart/flow/flow_shipping'           => 'cart_controller@flow_shipping',
    'cart/flow/edit_consignee_checked'  => 'cart_controller@edit_consignee_checked',
    'cart/flow/select_payment'           => 'cart_controller@select_payment',
//
...
//    'quickpay/flow/done'                => 'quickpay_controller@done',
      ...
      'groupbuy/index/init'               => 'groupbuy_controller@init',
      'groupbuy/index/show'               => 'groupbuy_controller@show',
      'groupbuy/index/goods_list'         => 'groupbuy_controller@goods_list',
];
